...
floorColorTexture.repeat.set(0.8, 0.8);
floorARMTexture.repeat.set(0.8, 0.8);
floorNormalTexture.repeat.set(0.8, 0.8);
floorDisplacementTexture.repeat.set(0.8, 0.8);
...
// Gost
const gost1 = new THREE.PointLight("#8800ff", 6);
const gost2 = new THREE.PointLight("#ff0088", 6);
const gost3 = new THREE.PointLight("#ff0000", 6);
...
const tick = () => {
  ...
  gost1.position.y =
    Math.sin(gost1Angle) *
    Math.sin(gost1Angle * 2.34) *
    Math.sin(gost1Angle * 3.45);
  ...
  gost2.position.y =
    Math.sin(gost2Angle) *
    Math.sin(gost2Angle * 2.34) *
    Math.sin(gost2Angle * 3.45);

  const gost3Angle = elapsedTime * 0.23;
  gost3.position.x = Math.cos(gost3Angle) * 6;
  gost3.position.z = Math.sin(gost3Angle) * 6;
  gost3.position.y =
    Math.sin(gost3Angle) *
    Math.sin(gost3Angle * 2.34) *
    Math.sin(gost3Angle * 3.45);
